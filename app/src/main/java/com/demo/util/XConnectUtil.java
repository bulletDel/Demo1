...
import com.demo.network.ConnectStatus;
...
public class XConnectUtil {
    ...
    public static String getProvidersName(Context ctx) {
        ...
        String IMSI = ((TelephonyManager) ctx
    ...
    public static String getNativePhoneNumber(Context ctx) {
        ...
        NativePhoneNumber = ((TelephonyManager) ctx
    ...
    public static int getAPNType(Context context) {
        ...
        if (netInfo != null) {
            ...
            if (nType == ConnectivityManager.TYPE_MOBILE) {
                netType = netInfo.getExtraInfo().equalsIgnoreCase("cmnet") ? 3
                        : 2;
     ...
     * 获取当前的网络状态 -1：没有网络 , 1：WIFI网络 , 2 ：wap网络 , 3：net网络
     */
    public static ConnectStatus getAPNTypeStatus(Context context) {
        ...
        if (netInfo != null) {
            int nType = netInfo.getType();
            if (nType == ConnectivityManager.TYPE_MOBILE) {
                status = netInfo.getExtraInfo().equalsIgnoreCase("cmnet") ? ConnectStatus.net
                        : ConnectStatus.wap;
            } else if (nType == ConnectivityManager.TYPE_WIFI)
    ...
    private static boolean isFastMobileNetwork(Context context) {
        ...
        Log.i("xu", "是否是快速网络" + telephonyManager.getNetworkType());
